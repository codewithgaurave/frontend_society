            ...
            <div className="mt-3 space-y-1 text-xs">
              {u.experience && (
                ...
                >
                  ...
                  <span className="font-semibold">
                    {u.experience} {Number(u.experience) ? "years" : ""}
                  </span>
                </div>
              )}
              ...
              {(u.serviceCharge || u.perHourCharge) && (
                ...
                >
                  ...
                  <span className="font-semibold text-right">
                    {u.serviceCharge && `Service: ₹${u.serviceCharge}`}{" "}
                    {u.serviceCharge && u.perHourCharge && " | "}
                    {u.perHourCharge && `Per Hour: ₹${u.perHourCharge}`}
                  </span>
                </div>
              )}
              ...
              {u.pincode && (
                ...
                >
                  ...
                  <span className="font-semibold">{u.pincode}</span>
                </div>
              )}
